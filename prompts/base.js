...
.big-number { font-size:clamp(2.5rem, 10cqi, 5rem); font-weight:800; color:var(--accent); line-height:1; font-family:'[heading]',serif; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:100%; }
.big-label { font-size:1.3rem; color:var(--white-dim); margin-top:.5rem; max-width:100%; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
...
⚠ CRITICAL CONSTRAINTS FOR THIS LAYOUT — NEVER violate:
  • big-number content: HARD LIMIT ≤5 characters, ZERO spaces.
    ONLY a number + ONE symbol suffix. Valid: 99%, 2X, 50+, $18B, 3.5x, 40%+
    NEVER: "QoQ", "ROI %", "30 days", compound expressions, words, or multiple symbols.
  • big-label: max 3 words, ideally 1–2 (e.g. "User Growth", "Uptime").
<section class="s">
  <div class="tag">[NN · SECTION LABEL]</div>
  <h2>[Slide title]</h2>
  <p class="subtitle">[Context line]</p>
  <div class="stat-grid">
    <div class="stat-box"><div class="big-number">[≤5 chars, number+symbol only]</div><div class="big-label">[1–3 words max]</div></div>
    <div class="stat-box"><div class="big-number">[≤5 chars, number+symbol only]</div><div class="big-label">[1–3 words max]</div></div>
    <div class="stat-box"><div class="big-number">[≤5 chars, number+symbol only]</div><div class="big-label">[1–3 words max]</div></div>
  </div>
</section>
