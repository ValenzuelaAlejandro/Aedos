...
JSON STRUCTURE:
{
  ...
  "cta": "string or null",
  "visual_world": {
    "real_world_analog": "The physical/cultural artifact this topic naturally belongs to — be MAXIMALLY concrete and specific, NOT a category label. CRITICAL: include the dominant 1-2 colors if they are culturally iconic for this artifact — these drive the entire visual palette downstream. Examples: 'classic hip-hop tour poster on matte black cardstock with chain-gold lettering', 'museum fine art catalog on cream thick stock with warm amber Earth-tone imagery', 'hacker terminal with phosphor-green glow on near-black', 'race weekend program booklet glossy with bold red and yellow sponsor palette', 'artisan recipe journal warm brown ink on kraft paper', 'academic physics textbook precision teal on white with ruled margin notes', '90s rap record inner sleeve stark black with bold gold lettering and chain iconography', 'rock/metal concert program bleach-white on charcoal with blood-red accent', 'jazz album artwork on matte earthy sleeve with dusty amber and rust tones', 'product teardown manual blueprint blue-white technical linework'. The more specific and color-rich your description, the better the downstream visual direction.",
