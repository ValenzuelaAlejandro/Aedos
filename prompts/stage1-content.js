...
JSON STRUCTURE:
{
  ...
  "cta": "string or null",
  "visual_world": {
    "real_world_analog": "The physical/cultural artifact this topic naturally belongs to — be concrete and specific, NOT a category label. Examples: 'concert tour poster printed on black paper', 'museum fine art catalog on thick stock', 'hacker terminal green-on-black printout', 'race weekend program booklet glossy', 'artisan recipe journal ink on craft paper', 'academic physics textbook with margin notes', 'vinyl record inner sleeve', 'product teardown technical manual'.",
